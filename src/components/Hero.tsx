  ...
  return (
    <section className="resp-px resp-py-hero" style={{ padding: "56px 56px 64px", borderBottom: "1px solid var(--border)", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
        ...
        <div className="resp-step-container" style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
          ...
          />
          <div className="animate-fade-in resp-step-arrow" style={{ display: "flex", alignItems: "center", color: "var(--text-3)", fontSize: "16px", flexShrink: 0, paddingBottom: "16px", opacity: 0, animationDelay: "0.8s" }}>→</div>
          ...
          />
          <div className="animate-fade-in resp-step-arrow" style={{ display: "flex", alignItems: "center", color: "var(--text-3)", fontSize: "16px", flexShrink: 0, paddingBottom: "16px", opacity: 0, animationDelay: "0.9s" }}>→</div>
          ...
          />
          <div className="animate-fade-in resp-step-arrow" style={{ display: "flex", alignItems: "center", color: "var(--text-3)", fontSize: "16px", flexShrink: 0, paddingBottom: "16px", opacity: 0, animationDelay: "1.0s" }}>→</div>
